...
class ListingTools:
    ...
    def update_product_information(
        ...
        try:
            ...
            entity_details = self.get_entity_details("SaaSProduct@1.0", product_id)
            ...
            change_set = [
                {
                    "ChangeType": "CreateOffer",
                    "Entity": {"Type": "Offer@1.0"},
                    "DetailsDocument": {"ProductId": product_id, "Name": offer_name},
                }
            ]
    ...
    def release_offer_to_limited(self, offer_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            response = self.catalog_client.start_change_set(
                ...
                ChangeSetName=f"Release offer {offer_id} to Limited",
            )
    ...
    def add_dimensions_and_pricing_for_usage(
        ...
        try:
            # Get current entity details
            product_details = self.get_entity_details("SaaSProduct@1.0", product_id)
            ...
            offer_details = self.get_entity_details("Offer@1.0", offer_id)
